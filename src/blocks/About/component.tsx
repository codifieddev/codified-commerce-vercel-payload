...
export const CTABlock: React.FC<CTABlockProps> = ({
  ...
  const getButtonClass = (btnStyle: string = "primary") => {
...
export const AboutPageRenderer: React.FC<BlockRendererProps> = ({ blocks }) => {
  return (
    <>
      {blocks.map((block, index) => {
        switch (block.blockType) {
          ...
          case "missionVision":
            return <MissionVisionBlock key={index} {...block} />;
          case "values":
            return <ValuesBlock key={index} {...block} />;
          case "team":
          ...
          case "culture":
            return <CultureBlock key={index} {...block} />;
          case "cta":
